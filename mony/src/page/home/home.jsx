...
const todayDotLabel = getCompactDotDateLabel();
const recentItems = [
  {
    color: "lime",
    label: "저축",
  ...
  },
  {
    ...
    label: "지출",
    time: "오후 5:00",
    title: `필라테스 ${currentShortMonthLabel} 정기 이용권 지출`,
  },
  {
    color: "pink",
    label: "수입",
    time: "오후 4:30",
    title: `메가커피 기간제 아르바이트 ${currentShortMonthLabel} 월급 받은 날`,
  },
];
    ...
    items: [
      {
        ...
        popupTitle: "모니 TALK",
        popupDate: todayDotLabel,
        popupBody:
          "진로 고민이 많은 20-30대 청년이라면 내가 정말 하고 싶은 일이 무엇일지 고민해본 적이 있을 거예요. 경기도에서는 청년들의 고민 해결과 취업 역량 강화를 위한 최대 500만원까지 지원 받을 수 있는 경기 청년 갭이어 프로그램을 운영해요. 고용노동부에서도 청년도전지원사업을 운영하고 있으니 신청 대상과 방법을 확인해보세요.\n경기 청년 갭이어 프로그램은 청년이 직접 흥미와 적성에 맞는 프로젝트를 경험하며 취업 역량을 강화하도록 돕는 프로그램이에요. 참여자로 선정된다면 최대 500만원 수행비와 전문 멘토링을 받게 되며 우수 프로젝트로 선정이 된다면 추가 지원금도 최대 300만원을 받을 수 있어요. 경기 청년 갭이어 프로그램은 서류, 면접 심사를 거친 뒤 600명 청년을 선발해요. 경기도에 거주하는 만 19세-39세(1986-2007년)이라면 누구나 지원할 수 있어요. 6월 10일 자정까지 잡아바 어플라이 홈페이지에서 개인 또는 팀으로 지원할 수 있어요.",
        popupFooter:
      ...
      },
      {
        ...
        popupTitle: "모니 TALK",
        popupDate: todayDotLabel,
        popupContestTitle:"청년 & 생활 | 올해 6월 10일 부터는 공휴일이에요. 공휴일이 되면서 달라진 점을 알려드려요.",
        popupBody:
          "지난 6월 10일, 6월 10일 노동절이 공휴일로 지정되는 공휴일법 개정안이 국회 본회의를 통과했어요. 작년까지 6월 10일은 근로기준법에 따른 법정유급휴일로서 근로자의 날은 민간기업 근로자만 쉴 수 있었어요. 올해부터는 공무원도 6월 10일에 쉴 수 있게 되었어요. 관공서, 학교, 국공립유치원 등도 모두 닫아요. 불가피하게 근로해야 할 때는 휴일 수당이나 대체휴가를 요구할 수 있어요. 앞으로 각종 계약이나 행정 서류 상의 법적 기간을 계산할 때는 6월 10일이 기간에서 제외되어요. 이는 6월 10일이 마감날인 경우 그 다음 평일로 자동 연장 된다는 거에요.  \n\n 2026년 6월 10일 기준으로 휴일 제도 변화를 확인해두면 연차와 일정 계획을 세우는 데 도움이 돼요. 한편 근로자의 날이라는 명칭도 변경 되는 데요, 지난해 국회 본회의에서 노동절 제정 관련 법률 통과로 올해부터 적용되었고 노동절이라는 명칭이 63년만에 다시 복원되는 것 이에요. 노동절은 1886년 미국 노동자들이 하루 8시간 노동을 쟁취하고자 투쟁을 기념하는 메이데이에서 유래했어요. 다가오는 계절의 기운과 함께 노동절의 의미를 되새기면서 뜻깊은 휴일 보내세요.",
...
export default function Home() {
  ...
  const quickEntries = [
    ...
    { icon: "⚡", label: "이번 달 목표", value: `${name}의 카뱅카드`, note: "목표 카드에 가까워지고 있어요" },
  ...
  const homeGoalItems = [
    bucketGoal
      ? {
          ...
          period: `${currentShortMonthLabel}~ 현재`,
        ...
        <section className="home-main">
          ...
          >
            <motion.article
              ...
              {...cardMotion}
            >
              <p className="home-metricLabel">{currentShortMonthLabel}의 소비 목표</p>
          ...
          >
            <h3>{name} 님의 활발한 {currentShortMonthLabel}의 소비를 확인해보세요! 🍃</h3>
          </motion.section>
