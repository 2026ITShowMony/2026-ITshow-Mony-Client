...
// bg.jsx의 이번달 예산목표 블록에 사용되는 캐릭터 이미지 경로
...
const talkGroups = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        popupDate: "2026.03.31",
        popupContestTitle:
          "청년 & 생활 | 올해 5월 1일 부터는 공휴일이에요. 공휴일이 되면서 달라진 점을 알려드려요.",
        popupBody:
      ...
      },
      {
        ...
        popupContestTitle:
          "청년 & 생활 | 나라에서 올해 첫 숙박 쿠폰을 나눠줘요. 봄 나들이 여행을 떠나보는건 어떨까요?",
        popupBody:
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        popupDate: "2026.03.31",
        popupContestTitle:
          "보험 | 암이 발견되면 어떻게 해야할까? 암 보험은 이렇게 준비하세요.",
        popupBody:
      ...
      },
      {
        ...
        popupDate: "2026.03.31",
        popupContestTitle:
          "보험 | 내가 사는 지역에서 무료로 들어주는 보험에 대해 알고 있나요?",
        popupBody:
    ...
    items: [
      {
        ...
        popupTitle: "모니 TALK",
        popupContestTitle:
          "부동산 | 올해부터 청약저축 소득공제의 대상이 확대되었어요.",
        popupDate: "2026.03.31",
        popupBody:
      ...
      },
      {
        ...
        popupDate: "2026.03.31",
        popupContestTitle:
          "부동산 | 계약을 앞두고 있을 때, 전세 계약 전 악성 임대인을 조회하세요.",
        popupBody:
...
export default function Home() {
  ...
  const benefitCardInView = useInView(benefitCardRef, {
    once: true,
    amount: 0.4,
  });
  const savingsProgressRef = useRef(null);
  const savingsProgressInView = useInView(savingsProgressRef, {
    once: true,
    amount: 0.6,
  });
  ...
  const handleTalkRefresh = () => {
    setActiveTalkGroupIndex(
      (currentIndex) => (currentIndex + 1) % talkGroups.length,
    );
  };
    ...
    <main className="home-page">
      <div className="home-shell">
        ...
        <section className="home-main">
              ...
              <div className="home-todayContent">
                ...
                <div className="home-metricRow">
                  <h3 className="home-metricInline">
                    총 <CountUp value={28000} suffix="원" /> /{" "}
                    <CountUp value={100000} suffix="원" />
                  </h3>
                </div>
                <p className="home-muted">
                  하루 소비 목표 금액에 도달하지 않았어요
                </p>
              </div>
              <img
          ...
          >
            {/* [변경] 좌측: 나의 버킷리스트 목표 블록 */}
            <motion.article
              className="home-panelCard home-bucketCard"
              variants={staggerItemVariants}
              {...cardMotion}
            >
              {bucketGoal ? (
                <>
                  ...
                  <h3 className="home-panelTitle home-bucketTitle">
                  ...
                  <div className="home-bucketStats">
                    ...
                    <div>
                      <span>월 저축</span>
                      <strong>
                        {Number(bucketGoal.monthlySaving ?? 0).toLocaleString()}
                        원
                      </strong>
                    </div>
                    <div>
                ...
                <div className="home-bucketEmpty">
                  <p className="home-panelMeta">나의 버킷리스트 목표</p>
                  <h3 className="home-panelTitle">
                    아직 설정된 버킷리스트 목표가 없어요
                  </h3>
                  <button
                    type="button"
            ...
            {/* [변경] 우측: 이번달의 예산목표 블록 */}
            <motion.article
              className="home-panelCard home-metricCard--goal"
              variants={staggerItemVariants}
              {...cardMotion}
            >
              <h3
              ...
              <div
                className="bg-goalLayout"
                style={{ display: "flex", gap: "1.5rem" }}
              >
                <div
                  className="bg-goalAvatarWrap"
                  style={{
                    display: "flex",
                  ...
                  {milestoneItems.map((item, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className="bg-goalRight"
                          style={{ textAlign: "right" }}
                        >
                          <div
                            className="bg-goalMeta"
                            style={{
                              fontSize: "0.75rem",
                              color: "#666",
                              display: "flex",
          ...
          >
            <motion.h3
              className="home-bottomFeatureTitle"
              variants={staggerItemVariants}
            >
            ...
            <div className="home-bottomFeatureGrid">
                      ...
                      <div className="home-benefitMeta">
                        <div>
                          ...
                          <strong>
                            {benefitCardInView ? (
                              <CountUp
                                value={parseMoney(row.pointValue)}
                                suffix="원"
                              />
                            ) : (
                              "0원"
                        ...
                        <div>
                          ...
                          <strong>
                            {benefitCardInView ? (
                              <CountUp
                                value={parseMoney(row.discountValue)}
                                suffix="원"
                              />
                            ) : (
                              "0원"
              ...
              <motion.article
                className="home-featureCard home-featureCard--talk"
                variants={staggerItemVariants}
                {...cardMotion}
              >
                <div className="home-featureHeader">
                  <div>
                    ...
                    <h4 className="home-featureTitle is-lime">
                      {activeTalkGroup.title}
                    </h4>
                  </div>
                  <button
                    type="button"
              ...
              <motion.article
                className="home-featureCard home-featureCard--budget"
                variants={staggerItemVariants}
                {...cardMotion}
              >
                <p className="home-featureLabel">예산목표를 설정해볼까요?</p>
                <img
                  className="home-budgetAvatar"
                  src={MonyImg}
                  alt=""
                  aria-hidden="true"
                />
              ...
              >
                ...
                <div className="home-talkModalHeader">
                  <div className="home-talkModalHeaderRow">
                    <p className="home-talkModalKicker">
                      {activeTalkItem.popupTitle}
                    </p>
                  </div>
                  <div className="home-talkModalHeaderRow">
                    ...
                    <span className="home-talkModalDate">
                      {activeTalkItem.popupDate}
                    </span>
                  </div>
                </div>
                ...
                {activeTalkItem.popupFooter && (
                  <p className="home-talkModalFooter">
                    {activeTalkItem.popupFooter}
                  </p>
                )}
              </div>
